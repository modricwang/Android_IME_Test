...
static const JNINativeMethod sMethods[] = {
    ...
    },
    {
        ...
        const_cast<char *>(
                "(J[Lio/github/ctrlaltdel/aosp/ime/latin/utils/WordInputEventForPersonalization;I)I"),
...
int register_BinaryDictionary(JNIEnv *env) {
    const char *const kClassPathName = "io/github/ctrlaltdel/aosp/ime/latin/BinaryDictionary";
